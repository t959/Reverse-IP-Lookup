...
<br />
        <center> <font color="red" face="iceland" size="10">Reverse IP Lookup</font>
		 <br /> <br />
<img src="https://cdn.pbrd.co/images/6RXeCi5n8.png" width="100" height="100">
<br /> <br />

		<form action="" id="form1" method="get" onsubmit=" location.href = 'http://viewdns.info/reverseip/?host=' + document.getElementById('url').value; return false; "> 
	
			<input type="text" name="url" value="mr-t959.xyz" id="url"/> 
